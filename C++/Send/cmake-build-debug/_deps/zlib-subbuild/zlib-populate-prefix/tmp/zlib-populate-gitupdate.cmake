...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" show-ref "2.0.6"
  WORKING_DIRECTORY "C:/BIF/Graduation/Code/C++/Send/cmake-build-debug/_deps/zlib-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/BIF/Graduation/Code/C++/Send/cmake-build-debug/_deps/zlib-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/BIF/Graduation/Code/C++/Send/cmake-build-debug/_deps/zlib-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
